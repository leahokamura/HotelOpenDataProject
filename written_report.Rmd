...
### Modeling Code (This Section Will Be Hidden)
```{r}

```

## Results
INSTRUCTIONS: In this section, you will output the final model and include a brief discussion of the model assumptions, diagnostics, and any relevant model fit statistics.
...
### Model Assumptions, Diagnostics, Limiation
