...
In this report, we are looking to use linear models to understand the contributing facors to hotel room price, as well as identify the strongest predictors.
