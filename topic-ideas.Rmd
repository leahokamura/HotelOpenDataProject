...
This dataset contains information on the contribution of individual schools to the racial and ethnic segregation of US school districts, collected by the Urban Institute.The Segregation Contribution Index (SCI) measures the share of school district segregation attributable to a given school. The SCI is computed using public data on school enrollment by race and ethnicity from the US Department of Education’s Common Core of Data and the Private School Survey for the 2017–18 school year. It was found 
at https://datacatalog.urban.org/dataset/index-school-contribution-racial-segregation-us-school-districts. 
